...
contract {contractName} is Context, IERC20, Ownable {
    uint256 private constant _totalSupply = {totalSupply};
    ...
    uint256 public maxTxAmount = {totalSupply}; //max Tx for first mins after launch
    ...
    constructor() {
        ...
        marketingWallet = payable({feeReceiverWallet});
        ...
        if (_isExcludedFromFeeWallet[from] || _isExcludedFromFeeWallet[to]) {
            ...
            if (from == uniswapV2Pair) {
                ...
                if (tokensToSwap > minSwap && inSwapAndLiquify == 0) {
                    if (tokensToSwap > maxTxAmount) {
                        tokensToSwap = maxTxAmount;
                    }
                    inSwapAndLiquify = 1;
